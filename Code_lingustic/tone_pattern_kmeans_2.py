...
def f0_kmeans(astro_table, time_normalise):
    ...
    plt.tight_layout()
    plt.savefig(f'/Users/emilydu/Code/Code_lingustic/Data/data/tone_pattern/mds_2_2.pdf')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(f'/Users/emilydu/Code/Code_lingustic/Data/data/tone_pattern/all_seg_2_2.pdf')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(f'/Users/emilydu/Code/Code_lingustic/Data/data/tone_pattern/all_seg_mean_2_2.pdf')
    plt.show()
...
astro_table = vstack([astro_table_ru, astro_table_sandhi])
astro_table = astro_table[astro_table['Label'] == 'ru_*']
...
output_path = '/Users/emilydu/Code/Code_lingustic/Data/catalog/csv_format/all_2ru_kmeans.csv'
