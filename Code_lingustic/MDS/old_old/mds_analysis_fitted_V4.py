...
def apply_mds_single_point(f0_tables_dict, niter, max_per_iter, hnr_lists, hnr_2parmas):
    ...
    for label, f0_table in f0_tables_dict.items():
        ...
        for hnr_header in hnr_lists:
            with open(f'/Users/emilydu/Code/Code_lingustic/Data/data/hnr/{hnr_header}_hnr_mu_sigma.pkl', 'rb') as f:
                fitted_gaussians = pickle.load(f)
            hnr_mu = fitted_gaussians[label][1]
            hnr_sigma = fitted_gaussians[label][2]
            
            if hnr_2parmas == False:
        ...
        with open(f'/Users/emilydu/Code/Code_lingustic/Data/plots/h1h2/h1h2_mu_sigma.pkl', 'wb') as f:
            ...
            mean_vector.append(fitted_gaussians[label][1])
            mean_vector.append(fitted_gaussians[label][2])
...
if use_mean:
    png_dir = f'/Users/emilydu/Code/Code_lingustic/Data/data/mds/fitted_mds/mds_niter_{niter}_mean_v4.png'
else:
    png_dir = f'/Users/emilydu/Code/Code_lingustic/Data/data/mds/fitted_mds/mds_niter_{niter}_median_v4.png'
...
plt.title(f'niter = {niter}_V4', fontsize = 28)
