...
if use_mean:
    if hnr_2parmas == False:
        png_dir = f'/Users/emilydu/Code/Code_lingustic/Data/data/mds/fitted_mds/mds_niter_{niter}_mean_v3.png'
    if hnr_2parmas == True:
        png_dir = f'/Users/emilydu/Code/Code_lingustic/Data/data/mds/fitted_mds/mds_niter_{niter}_mean_v3.5.png'
else:
    if hnr_2parmas == False:
        png_dir = f'/Users/emilydu/Code/Code_lingustic/Data/data/mds/fitted_mds/mds_niter_{niter}_median_v3.png'
    if hnr_2parmas == True:
        png_dir = f'/Users/emilydu/Code/Code_lingustic/Data/data/mds/fitted_mds/mds_niter_{niter}_median_v3.5.png'
