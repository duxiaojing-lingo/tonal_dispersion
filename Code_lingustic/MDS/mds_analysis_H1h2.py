...
def apply_mds_single_point(f0_tables_dict, niter, max_per_iter, hnr_header):
    ...
    for label, f0_table in f0_tables_dict.items():
        ...
        all_mu = [v[1] for v in fitted_gaussians.values()]
        max_fo_mu = max(all_mu)
        h1h2_mu = fitted_gaussians[label][1] / max_fo_mu
...
if use_mean:
    png_dir = f'/Users/emilydu/Code/Code_lingustic/Data/data/mds/fitted_mds_new/mds_niter_{niter}_mean_h1h2_1.png'
else:
    png_dir = f'/Users/emilydu/Code/Code_lingustic/Data/data/mds/fitted_mds_new/mds_niter_{niter}_median_h1h2_1.png'
